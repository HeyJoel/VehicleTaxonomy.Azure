...
namespace VehicleTaxonomy.Domain.Tests.DataImport;
...
public class ImportTaxonomyFromCsvCommandHandlerTests
{
    ...
    public ImportTaxonomyFromCsvCommandHandlerTests(DbDependentFixture dbDependentFixture)
    {
    ...
    {
        const string makeId = "imptaxcsvch-valsrow";
        const string modelId = "abarth-124";
        const string variantId = "124-gt-multiair-1-4l-petrol";
    ...
    {
        await using var serviceProvider = _dbDependentFixture.CreateServiceProvider(services =>
        {
    ...
    {
        const string makeId = "imptaxcsvch-modeval-notimp";
    ...
    private EmbeddedResourceFileSource GetTestFileSourceAsync(string uniqueName)
    {
        var fileSource = new EmbeddedResourceFileSource(
            GetType().Assembly,
            "VehicleTaxonomy.Domain.Tests.Tests.DataImport.TestResources",
