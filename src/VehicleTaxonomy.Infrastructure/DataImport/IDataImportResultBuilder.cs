namespace VehicleTaxonomy.Infrastructure.DataImport;
...
public interface IDataImportResultBuilder
{
    ...
    /// The messages should not be record-specific, as this will prevent errors from being
    ...
    /// text should not be record-specific, as this will prevent errors from being
    /// aggregated and bloat the size of the result.
    /// </param>
