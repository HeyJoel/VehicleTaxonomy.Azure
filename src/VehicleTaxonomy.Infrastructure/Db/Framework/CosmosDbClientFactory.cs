...
/// batch. CosmosDb clients should be singletons to avoid port exhaustion
/// with the underlying HttpClient. <see cref="CosmosDbClientFactory"/>
...
public sealed class CosmosDbClientFactory : IDisposable
{
    ...
    public CosmosDbClientFactory(CosmosDbOptions cosmosDbOptions)
    {
